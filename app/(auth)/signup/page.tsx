        ...
        <div className="bg-white border border-stone-300 rounded-2xl shadow-lg p-8">
          ...
          <div className="mx-auto max-w-3xl">
            <p
              ...
              data-aos-delay={200}
            >
              Sign up to explore curated data roles across Europe.
            </p>
            {/* Contact form */}
              ...
              <div className="mt-6 space-y-5">
                ...
                <button className="btn relative w-full bg-stone-100 text-[#273e3d] font-bold hover:bg-stone-200 py-2 text-base rounded-full cursor-pointer flex items-center justify-center gap-2">
                  ...
                  >
                    <path
                      fill="#EA4335"
                      d="M24 9.5c3.15 0 5.9 1.15 8.1 3.05l6.05-6.05C34.15 3.5 29.4 1.5 24 1.5 14.85 1.5 7.2 7.4 4.2 15.35l7.45 5.8C13.2 14.2 18.2 9.5 24 9.5z"
                    />
                    <path
                      fill="#34A853"
                      d="M46.35 24.5c0-1.6-.15-3.15-.45-4.65H24v9.3h12.7c-.55 2.8-2.2 5.15-4.7 6.75l7.45 5.8c4.35-4.05 6.9-10.05 6.9-17.2z"
                    />
                    <path
                      fill="#4A90E2"
                      d="M10.65 28.15c-.55-1.6-.85-3.3-.85-5.15s.3-3.55.85-5.15l-7.45-5.8C2.4 15.4 1.5 19.6 1.5 24s.9 8.6 2.7 12.85l7.45-5.8z"
                    />
                    <path
                      fill="#FBBC05"
                      d="M24 46.5c5.4 0 10.15-1.8 13.55-4.9l-7.45-5.8c-2.05 1.4-4.7 2.25-6.1 2.25-5.8 0-10.8-4.7-12.35-10.95l-7.45 5.8C7.2 40.6 14.85 46.5 24 46.5z"
                    />
                  </svg>
                  Sign Up with Google
                </button>
